...
sub outer_product__vector_bivector_euclidean {
    ...
    # DEV NOTE, CORRELATION #mp010: calculated the same way as outer_product__bivector_vector_euclidean()!
    $return_value_number
...
sub outer_product__bivector_vector_euclidean {
    ...
    # DEV NOTE, CORRELATION #mp010: calculated the same way as outer_product__vector_bivector_euclidean()!
    $return_value_number
        = ( $input_bivector->[1] * $input_vector->[3] ) + ( $input_bivector->[2] * $input_vector->[1] ) + ( $input_bivector->[3] * $input_vector->[2] );
