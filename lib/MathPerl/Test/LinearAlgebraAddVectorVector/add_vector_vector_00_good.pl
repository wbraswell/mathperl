...
#print 'have MathPerl__DataStructure__Vector__Vector_to_string( $manual_perl_vector ) = ' . q{'} . 
#    MathPerl__DataStructure__Vector__Vector_to_string( $manual_perl_vector ) . q{'} . "\n\n";
...
$retval_vector = test_constructor(8);
...
$retval_vector_raw = add_vector_vector_raw( $input_vector_0->get_head(), $input_vector_0->get_head() );
